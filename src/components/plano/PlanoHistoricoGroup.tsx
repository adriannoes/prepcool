...
const PlanoHistoricoGroup = ({ grupo }: PlanoHistoricoGroupProps) => {
  ...
  const getTipoBadge = (tipo: string) => {
    if (tipo === 'video') {
      return <Badge variant="outline" className="border-blue-200 text-blue-700">Vídeo</Badge>;
    }
    return <Badge variant="outline" className="border-purple-200 text-purple-700">Exercício</Badge>;
  };
            ...
            <div className="flex items-center space-x-2">
              <div className="text-right">
                ...
                <div className="w-24 bg-gray-200 rounded-full h-2 mt-1">
                  <div 
                    className="bg-[#5E60CE] h-2 rounded-full transition-all duration-300"
